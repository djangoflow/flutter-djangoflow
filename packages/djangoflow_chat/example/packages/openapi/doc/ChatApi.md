...
# **chatImagesCreate**
> MessageImage chatImagesCreate(messageId, roomId, image)
...
try {
    final response = api.chatImagesCreate(messageId, roomId, image);
    print(response);
} catch on DioError (e) {
...
# **chatImagesUpdate**
> MessageImage chatImagesUpdate(id, messageId, roomId, image)
...
try {
    final response = api.chatImagesUpdate(id, messageId, roomId, image);
    print(response);
} catch on DioError (e) {
