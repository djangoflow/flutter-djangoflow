...
void main() {
  ...
  group(ChatApi, () {
    //Future<MessageImage> chatImagesCreate({ String messageId, String roomId, MultipartFile image }) async
    ...
    //Future<MessageImage> chatImagesUpdate(String id, { String messageId, String roomId, MultipartFile image }) async
