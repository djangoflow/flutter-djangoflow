...
class Room {
  ...
  @JsonKey(name: r'creator_id', required: false, includeIfNull: false)
  final String? creatorId;

  @JsonKey(name: r'message_total_count', required: false, includeIfNull: false)
  final int? messageTotalCount;

  @JsonKey(name: r'message_new_count', required: false, includeIfNull: false)
  final int? messageNewCount;

  @JsonKey(name: r'last_message', required: false, includeIfNull: false)
  final Message? lastMessage;

  @JsonKey(name: r'is_muted', required: false, includeIfNull: false)
  final bool? isMuted;
  ...
  @JsonKey(name: r'is_public', required: false, includeIfNull: false)
  final bool? isPublic;
