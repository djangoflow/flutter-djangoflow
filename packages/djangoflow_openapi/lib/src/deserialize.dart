...
ReturnType deserialize<ReturnType, BaseType>(dynamic value, String targetType,
  ...
  switch (targetType) {
    ...
    case 'MessageSeenRequest':
      return MessageSeenRequest.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'OTPObtainRequest':
      return OTPObtainRequest.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'PaginatedMessageImageList':
      return PaginatedMessageImageList.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'PaginatedMessageList':
      return PaginatedMessageList.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'PaginatedRoomList':
      return PaginatedRoomList.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'PatchedMessageRequest':
      return PatchedMessageRequest.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'PatchedRoomRequest':
      return PatchedRoomRequest.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    ...
    case 'TokenRefreshSlidingRequest':
      return TokenRefreshSlidingRequest.fromJson(value as Map<String, dynamic>)
          as ReturnType;
