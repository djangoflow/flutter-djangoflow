...
#### `djangoflow_facebook_analytics` - `v0.2.0`
...
Packages with other changes:
 ...
 - [`djangoflow_remote_config` - `v0.0.3+1`](#djangoflow_remote_config---v0031)
...
Packages with other changes:
 ...
 - [`djangoflow_auth` - `v0.2.1+3`](#djangoflow_auth---v0213)
 - [`djangoflow_auth_google` - `v0.0.3+5`](#djangoflow_auth_google---v0035)
 - [`djangoflow_auth_apple` - `v0.0.5+5`](#djangoflow_auth_apple---v0055)
 - [`djangoflow_auth_discord` - `v0.0.4+6`](#djangoflow_auth_discord---v0046)
 - [`djangoflow_auth_facebook` - `v0.0.4+5`](#djangoflow_auth_facebook---v0045)
...
#### `djangoflow_openapi_extensions` - `v0.0.2`
 ...
 - **REFACTOR**: update generate-openapi.sh to support custom hostname. ([90b2ff10](https://github.com/djangoflow/flutter-djangoflow/commit/90b2ff10f3d4491a0c6d57536a88b7b120b8b6ff))
 - **FEAT**: support API_VERSION as cmd arg. ([74f41ea9](https://github.com/djangoflow/flutter-djangoflow/commit/74f41ea9553a1129e8b561a20e711b52000ca846))
 - **FEAT**: add generate-openapi.sh tool. ([5a770218](https://github.com/djangoflow/flutter-djangoflow/commit/5a77021884f7a8e8c0789814326749a014657046))
 - **DOCS**: add generate-openapi.sh related doc. ([b41de461](https://github.com/djangoflow/flutter-djangoflow/commit/b41de4612848289b22e91b1120054199395fec69))
